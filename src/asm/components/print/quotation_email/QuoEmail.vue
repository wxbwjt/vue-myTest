...
*/
<template>
    <div class="ys-print-list" style="display: none;" id="ys-email-list">
        <div style="padding:30px;">
            <div id="emailHeader">
                <email-head></email-head>
                <p style="width:90%;text-align:left;color:#ddd" align="left"></p>
            </div>
            <div id="emailDetail">
                <table class="parts-body" cellspacing="0" cellpadding="0" border="1px" style="width:102%;margin-top:8px;border-collapse:collapse">
                    <thead>
...
<script>
    ...
    import EmailFoot from "./EmailFoot";
    export default{
        components: {
            EmailFoot,
            EmailHead},
